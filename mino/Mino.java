...
public class Mino {
    ...
    public void checkMovementCollision() {
        ...
        // Check floor - aangepast om te checken of een van de blokken de bodem raakt
        for(int i=0; i < b.length; i++) {
    ...
    private void deactivating() {
        ...
        if (deactiveCounter == 45) {
            ...
            checkMovementCollision();   //check if the bottom is stil hitting
